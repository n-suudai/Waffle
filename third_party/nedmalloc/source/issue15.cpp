...
int div_w = 8; // block size to be sure that we touching pointers allocated from
...
void *malt2(void *threadid)
{
    malt(1);
}
void *malt3(void *threadid)
{
    malt(2);
}
void *malt4(void *threadid)
{
    malt(3);
}
void *malt5(void *threadid)
{
    malt(4);
}
void *malt6(void *threadid)
{
    malt(5);
}
void *malt7(void *threadid)
{
    malt(6);
}
void *malt8(void *threadid)
{
    malt(7);
}
void *malt9(void *threadid)
{
    malt(8);
}
void *malt10(void *threadid)
{
    malt(9);
}
...
void MallocStabTest3()
{
    ...
    for (int Z = 0; Z < 100; Z++)
    {
        div_w = 2 + (rand() % 40); // random block size to be sure that we
                                   // touching pointers allocated from different
                                   // thread ID-s
